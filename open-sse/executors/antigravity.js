...
export class AntigravityExecutor extends BaseExecutor {
  ...
  getRetryConfig(credentials) {
    return {
      ...this.config.retry,
      [HTTP_STATUS.SERVICE_UNAVAILABLE]: {
        ...(typeof this.config.retry?.[HTTP_STATUS.SERVICE_UNAVAILABLE] === "object"
          ? this.config.retry[HTTP_STATUS.SERVICE_UNAVAILABLE]
          : {}),
        attempts: credentials?.antigravity503RetryCount ?? DEFAULT_AG_503_RETRY_COUNT,
      },
    };
  }
