...
This project is indexed by GitNexus as **n9router** (4125 symbols, 11144 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
