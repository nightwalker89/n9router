...
This project is indexed by GitNexus as **n9router** (11632 symbols, 19350 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
