...
docker run -d --name 9router -p 20128:20128 \
  -v "$HOME/.n9router:/app/data" -e DATA_DIR=/app/data \
...
- **macOS/Linux**: `~/.n9router/db.json`
- **Windows**: `%APPDATA%/n9router/db.json`
- **Docker**: `/app/data/db.json` (mount `$HOME/.n9router` to persist)
